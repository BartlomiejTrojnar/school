...
class ClassroomController extends Controller
{
    public function index(ClassroomRepository $classroomRepo) {
        ...
        return view('classroom.index')
            -> nest('classroomTable', 'classroom.table', ["classrooms"=>$classrooms, "subTitle"=>""]);
    }
    ...
    public function show($id, ClassroomRepository $classroomRepo, LessonPlanRepository $lessonPlanRepo, TermRepository $termRepo, ExamRepository $examRepo, $view='') {
        ...
        switch(session()->get('classroomView')) {
            ...
            case 'showTerms':       return $this -> showTerms($termRepo);
            case 'showExams':       return $this -> showExams($examRepo);
            default:
    ...
    private function showTerms($termRepo) {
        ...
        $termTable = view('term.table', ["terms"=>$terms, "sessionSelectField"=>"", "examDescriptionSelectField"=>"", "classroomSelectField"=>""]);
    ...
    private function showExams($examRepo) {
        ...
        $examTable = view('exam.table', ["exams"=>$exams, "declarationSelectField"=>"", "examDescriptionSelectField"=>"", "termSelectField"=>"", "examTypeSelectField"=>""]);
