...
class TeacherController extends Controller
{
    ...
    public function store(Request $request) {
        $this -> validate($request, [ 'first_name' => 'max:16', 'last_name' => 'required|max:18', 'family_name' => 'max:15',
                'short' => 'max:2', 'degree' => 'max:10', 'order' => 'required|integer|between:0,20', ]);
    ...
    public function edit(Request $request, Teacher $teacher, ClassroomRepository $classroomRepo, SchoolYearRepository $schoolYearRepo) {
        ...
        return view('teacher.edit', ["teacher"=>$teacher, "classroomSF"=>$classroomSF, "firstYearSF"=>$firstYearSF, "lastYearSF"=>$lastYearSF]);
    }
    ...
    private function showGroups($syRepo, $gradeRepo, $subjectRepo, $groupRepo) {
        ...
        $teacherGroups = view('group.table', ["groups"=>$groups, "subTitle"=>"grupy nauczyciela", "version"=>"forTeacher", "start"=>$start, "end"=>$end,
            "gradeSF"=>$gradeSF, "subjectSF"=>$subjectSF, "levelSF"=>$levelSF, "teacherSF"=>"", "grade_id"=>0, "schoolYearSF"=>""]);
    ...
    private function showGrades($syRepo, $gradeRepo, $schoolRepo) {
        ...
        $teacherGrades = view('grade.tableForTeacher', ["grades"=>$grades, "subTitle"=>"klasy nauczyciela", "year"=>$year, "schoolSF"=>$schoolSF, "schoolYearSF"=>$schoolYearSF]);
