@extends('layouts.app')
@section('header')
  <h1>Dodawanie świadectwa</h1>
@endsection

@section('main-content')
  <form action="{{ route('swiadectwo.store') }}" method="post" role="form">
  {{ csrf_field() }}
    <table>
      <tr>
      ...
      <tr>
        ...
        <td><input type="date" name="date_of_council" required /></td>
      </tr>
      <tr>
        <th><label for="date_of_release">data wydania świadectwa</label></th>
        <td><input type="date" name="date_of_release" required /></td>
      </tr>
