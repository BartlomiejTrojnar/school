@extends('layouts.app')
@section('header')
  <h1>Modyfikowanie deklaracji</h1>
@endsection
  ...
  {{ method_field('PATCH') }}
    <table>
      ...
      <tr>
        ...
        <td><input type="number" name="application_number" min="1" max="10" required value="{{$declaration->application_number}}" /></td>
      </tr>
      <tr>
        <th><label for="student_code">kod ucznia</label></th>
        <td><input type="text" name="student_code" size="2" maxlength="3" value="{{$declaration->student_code}}" /></td>
      </tr>
