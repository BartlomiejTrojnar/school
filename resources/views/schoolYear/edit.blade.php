...
@section('main-content')
  ...
  {{ method_field('PATCH') }}
    <table>
      <tr>
        <th><label for="date_start">data rozpoczęcia</label></th>
        <td><input type="date" name="date_start" value="{{ $schoolYear->date_start }}" required /></td>
      </tr>
      <tr>
        <th><label for="date_end">data zakończenia</label></th>
        <td><input type="date" name="date_end" value="{{ $schoolYear->date_end }}" required /></td>
      </tr>
      <tr>
