  ...
  <table id="schoolYears">
    ...
    @foreach($schoolYears as $sy)
      <tr>
        ...
        <td><a href="{{ route('rok_szkolny.edit', $sy->id) }}"><img class="edit" src="{{ asset('css/zmiana.png') }}" alt="[]"></a></td>
        <td>
    ...
    @endforeach
      <tr class="create">
        <td colspan="9"><a href="{{ route('rok_szkolny.create') }}"><img class="create" src="{{ asset('css/plus.png') }}" /></a></td>
      </tr>
    </tbody>
  </table>
@endsection