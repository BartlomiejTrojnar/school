...
<aside>
  <p>Dane importowane są z pliku <strong style="border: 1px solid #66f; padding: 5px; background: #555; color: #aaf;">C:/dane/DaneUczniow.xlsx</strong>. Arkusz powinien nosić nazwę <em style="border: 1px solid #66f; padding: 5px; background: #555; color: #aaf;">Uczniowie</em>.</p>
