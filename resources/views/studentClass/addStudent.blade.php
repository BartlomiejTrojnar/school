...
@section('header')
  <h1>Dodawanie ucznia do klasy</h1>
@endsection
  ...
  {{ csrf_field() }}
    <table>
      ...
      <tr>
        ...
        <td><input type="date" name="date_start" size="8" maxlength="10" id="date_start" /></td>
        <td><input type="checkbox" name="confirmation_date_start" /></td>
        <td><a id="date_start1" href="">{{ $dates['dateOfSession'] }}</a></td>
<?php /*        <td><a id="date_start2" href="">{{ $dates['dateOfStartSchoolYear'] }}</a></td>
        */ ?>
      </tr>
      <tr>
...
<?php /*        <td><a id="date_end2" href="">{{ $dates['dateOfGraduationOfTheLastGrade'] }}</a></td>
...
*/ ?>
      ...
      <tr>
        ...
        <td><a id="proposedNumer" href="">{{ $proposedNumer }}</a></td>
      </tr>
      <tr>
