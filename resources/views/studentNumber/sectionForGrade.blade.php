   ...
   <div id="tips">
      @if( !empty($grade) && !empty($yearOfStudy) && $yearOfStudy>1 )
         <section id="copyStudentNumbers">
            <button class="run btn btn-primary"><i class="fas fa-copy"></i> kopiuj numery</button>
            <button class="help"><i class='far fa-question-circle' style='font-size:24px'></i></button>
      ...
      <section id="confirmNumbers">
         <button class="run btn btn-primary"><i class="fas fa-lock"></i> potwierdź numery</button>
         <button class="help"><i class='far fa-question-circle' style='font-size:24px'></i></button>
      ...
      <section id="addNumbersForGrade">
         <button class="run btn btn-primary"><i class="fas fa-lock"></i> dodaj numery dla wszystkich uczniów klasy</button>
         <button class="help"><i class='far fa-question-circle' style='font-size:24px'></i></button>
