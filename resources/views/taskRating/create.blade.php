  ...
  {{ csrf_field() }}
    <table>
      ...
      <tr>
        ...
        <td><input type="number" name="version" size="1" maxlength="1" required /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="datetime-local" name="rating_date" /></td>
      </tr>
      <tr>
        <th><label for="points">punkty</label></th>
        <td><input type="text" name="points" size="3" maxlength="4" /></td>
      </tr>
      <tr>
      ...
      <tr>
        ...
        <td><input type="datetime-local" name="entry_date" /></td>
      </tr>
